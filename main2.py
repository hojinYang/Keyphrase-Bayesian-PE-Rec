...
if __name__ == "__main__":
    ...
    parser.add_argument('--step', dest='step', type=check_int_positive, default=10, help='Num of steps for elicitation process')
    ...
    parser.add_argument('--prec_item', dest='prec_item', type=check_float_positive, default=0.01, help='precision used in item likelihood')
