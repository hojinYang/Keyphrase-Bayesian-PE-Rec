...
if __name__ == "__main__":
    ...
    parser.add_argument('--prec_W', dest='prec_W', type=check_float_positive, default=0.0001,
                        help='precision used in weight matrix')
    parser.add_argument('--prec_item', dest='prec_item', type=check_float_positive, default=0.001,
                        help='precision used in item likelihood')
    parser.add_argument('--prec_tag', dest='prec_tag', type=check_float_positive, default=1,
    ...
    parser.add_argument('--alpha', dest='alpha', type=check_float_positive, default=1,
                        help='leverage on varince used in UCB')
